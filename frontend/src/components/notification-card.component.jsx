...
import NotificationComponetField from "./notification-comment-field.component";
...
const NotificationCard=({data,index,notificationState}) => {
    ...
    let {userAuth:{access_token,username:author_username,profile_img:author_profile_img}}=useContext(UserContext);
    ...
    return (
        <div className={"p-6 borber-b border-grey border-l-black"+(!seen ? "border-l-2":"")}>
                ...
                <div className="w-full">
...

                    {
                        ...
                        <div className="p-4 mt-4 rounded-md bg-grey">
                            <p>{replied_on_comment.comment}</p></div>
                        :
...

            {
                isReplying ? 
                <div className="mt-8 ">
                    <NotificationComponetField _id={_id} blog_author={user} index={index} replyingTo={comment._id} setReplying={setReplying} notification_id={notification_id} notificationData={notificationState}/>
                </div>:""
            }
            {
                reply ? 
                <div className="ml-20 p-5 bg-grey mt-5 rounded-md">
                    ...
                    <button className="underline hover:text-black ml-12 mt-2" onClick={(e) => handleDelete(comment._id,"reply",e.target)}>Delete</button>
